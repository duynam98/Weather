...
public class CurrenWeatherDAO {
    ...
    public List<CurrenLocalCity> getAllNote() {
    ...
    public CurrenLocalCity geCity(String cityname) {
    ...
    public long updateNote(City city) {
        SQLiteDatabase db = databaseHelper.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(Constant.COLUMN_NAME_CITY, city.getName_city());
        values.put(Constant.COLUMN_TEMP_C, city.getTemp_C());
        values.put(Constant.COLUMN_IMAGE, city.getImage());
        values.put(Constant.COLUMN_LAT, city.getLatitude());
        values.put(Constant.COLUMN_LON, city.getLongtitude());
        return db.update(Constant.TABLE_CURRENT_WEATHER, values, Constant.COLUMN_NAME_CITY + " = ?",
                new String[]{String.valueOf(city.getName_city())});
    }
