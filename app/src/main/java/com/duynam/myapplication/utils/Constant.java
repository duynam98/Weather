...
public class Constant {
    ...
    public static final String BASE_URL_FULLMOON = "https://api.aerisapi.com//sunmoon/moonphases/hanoi,vi?from=today&to=+60days&limit=100&&client_id=Z7as1KXeYUAArUzzDSmxy&client_secret=wzwBMACRdWu8gaj7tfppdhXMivMTy4KperCCtfRK&query=type:full";
    public static final String BASE_URL_LASTQUARTER = "https://api.aerisapi.com//sunmoon/moonphases/hanoi,vi?from=today&to=+100days&limit=100&&client_id=Z7as1KXeYUAArUzzDSmxy&client_secret=wzwBMACRdWu8gaj7tfppdhXMivMTy4KperCCtfRK";
